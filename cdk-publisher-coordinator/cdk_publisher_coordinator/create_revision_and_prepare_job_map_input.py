...
class CreateRevisionAndPrepareJobMapInput(Construct):
    @property
    def function(self):
        return self._func
    @property
    ...
    def __init__(self, scope: Construct, id: str, log_level: str, solution_uuid: str, **kwargs):
        ...
        self._func = aws_lambda.Function(self,
            ...
            code=aws_lambda.Code.from_asset("../source/CreateRevisionAndPrepareJobMapInputFunction"),
        ...
        self._task = aws_stepfunctions_tasks.LambdaInvoke(self,
            "CreateRevisionAndPrepareJobMapInputTask",
